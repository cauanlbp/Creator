...
creatorCoords = vec3(-1615.14,-1063.86,13.03)
creatorHeading = 344.06


spawnCoords = vec3(-490.29,-697.88,33.25)
spawnHeading = 2.51
...
function selectCharacter(info)
    if info then
        ...
        TriggerEvent("nyo:setTattoos", info.tattoos)
    end
...
spawns = {
    { name = "Garagem Praça", coords = {54.81,-879.49,30.36,339.79} },
    { name = "Garagem Sandy Shores", coords = {322.08,2619.06,44.49,346.5} },
...
function fclient.setOldChar(char, custom, gender, user_id)
    ...
    return getPlayerChar(PlayerPedId())
end